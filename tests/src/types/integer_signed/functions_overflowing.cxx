...
TEST_SUITE("signed integer<T>" * doctest::description(""))
{
                       ...
                       ztd::v2::isize)
    {
        ...
        SUBCASE("overflow")
        {
            ...
            { // positive * negative
                auto [result, overflow] = Integer::MAX().overflowing_mul(Integer::MIN());

                CHECK(overflow);
            }

            { // negative * positive
                auto [result, overflow] = Integer::MIN().overflowing_mul(Integer::MAX());

                CHECK(overflow);
            }

            { // negative * negative
                auto [result, overflow] = Integer::MIN().overflowing_mul(Integer::MIN());
                       ...
                       ztd::v2::isize)
    {
        ...
        SUBCASE("basic")
        {
            ...
            {
                auto [result, overflow] = x.overflowing_shl(shift);
        ...
        {
            auto x = Integer(type(2));
            [[maybe_unused]] auto [result, overflow] = x.overflowing_shl(129_u32);
            CHECK(overflow);
        }
    }
                       ...
                       ztd::v2::isize)
    {
        ...
        SUBCASE("basic")
        {
            ...
            {
                auto [result, overflow] = x.overflowing_shr(shift);
        ...
        {
            auto x = Integer(type(2));
            [[maybe_unused]] auto [result, overflow] = x.overflowing_shr(129_u32);
            CHECK(overflow);
        }
    }
}
