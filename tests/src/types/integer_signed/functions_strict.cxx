...
TEST_SUITE("signed integer<T>" * doctest::description(""))
{
                       ...
                       ztd::v2::isize)
    {
        ...
        SUBCASE("example")
        {
            ...
            CHECK(x.strict_div_euclid(-y) == -1);   // 7 >= -4 * -1
            CHECK((-x).strict_div_euclid(y) == -2); // -7 >= 4 * -2
            CHECK((-x).strict_div_euclid(-y) == 2); // -7 >= -4 * 2
        }
                       ...
                       ztd::v2::isize)
    {
        SUBCASE("basic")
        {
            ...
            {
                auto result = x.strict_shl(shift);
                       ...
                       ztd::v2::isize)
    {
        SUBCASE("basic")
        {
            ...
            {
                auto result = x.strict_shr(shift);
