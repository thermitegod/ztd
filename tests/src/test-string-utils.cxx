 ...
 */
TEST(string_utils, replace_multiple__vector_pair)
{
...
TEST(string_utils, replace_multiple__vector_pair__missing)
{
    std::string str = "%f%b %f%b %f%b";
...
TEST(string_utils, replace_multiple__vector_pair__count_neg)
{
    std::string str = "%f%b %f%b %f%b";
    std::vector<std::pair<std::string, std::string>> find_replace = {{"%f", "foo"}, {"%b", "bar"}};
...
TEST(string_utils, replace_multiple__vector_pair__count_0)
{
    std::string str = "%f%b %f%b %f%b";
    std::vector<std::pair<std::string, std::string>> find_replace = {{"%f", "foo"}, {"%b", "bar"}};
...
TEST(string_utils, replace_multiple__vector_pair__count_1)
{
    std::string str = "%f%b %f%b %f%b";
    std::vector<std::pair<std::string, std::string>> find_replace = {{"%f", "foo"}, {"%b", "bar"}};
...
TEST(string_utils, replace_multiple__vector_pair__count_2)
{
    std::string str = "%f%b %f%b %f%b";
    std::vector<std::pair<std::string, std::string>> find_replace = {{"%f", "foo"}, {"%b", "bar"}};
...
TEST(string_utils, replace_multiple__vector_pair__count_3)
{
    std::string str = "%f%b %f%b %f%b";
    std::vector<std::pair<std::string, std::string>> find_replace = {{"%f", "foo"}, {"%b", "bar"}};
