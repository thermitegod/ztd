...
namespace detail
{
template<typename T> struct shr final
{
    T x;
    u32 shift;
    T result;
...
template<typename T>
std::vector<detail::shr<T>> shr_data{
    // zero
    {
    ...
    {
        .x = T(typename T::integer_type(40)),
        .shift = 0_u32,
        .result = T(typename T::integer_type(40)),
    },
    ...
    {
        .x = T(typename T::integer_type(16)),
        .shift = 4_u32,
        .result = T(typename T::integer_type(1)),
    },
    {
        .x = T(typename T::integer_type(23)),
        .shift = 2_u32,
